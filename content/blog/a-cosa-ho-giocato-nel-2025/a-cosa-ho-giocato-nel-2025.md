---
title: A cosa ho giocato nel 2025
description: Cosa ho terminato e cosa no
date: 2026-01-03
tags: ["videogames"]
---

Come per il 2024, anche quest'anno condivido la lista dei giochi che ho completato durante gli ultimi dodici mesi, aggiungendo però anche quelli che ho abbandonato lungo la strada e quelli che mi accompagneranno anche per il 2026.

## Giochi completati

![I videogame che ho completato nel 2025](./videogame-2025.png)

14 giochi rispetto ai 17 dello scorso anno, e esperienze decisamente più piccole. Si vede che è stato un anno impegnativo su altri fronti, e si vede che ad un certo punto è arrivato **Silksong** (more on that later) che ha monopolizzato la mia attenzione.

Diamo un'occhiata in dettaglio ai singoli giochi, in ordine di completamento
...
Il nostro insetto, con fare simile a quello di uno scarabeo stercorario, può **trasportare delle sfere** sulla sua schiena e posarle dove serve principalmente per attivare meccanismi presenti nel mondo di gioco. Ma queste non sono sfere normali, sono **veri e proprio mondi**, e ci saranno occasioni in cui poter "saltare" dentro alla sfera stessa e trovarci in un mondo tutto nuovo. E, magari, trovare al suo interno altre sfere.

Capirete già da queste poche righe di testo come il gioco sia qualcosa di assolutamente unico. Impegnativo verso la fine, non difficilissimo, ma vi lascerà più volte a bocca aperta pensando *Ma davvero posso fare questa cosa?*.

COCOON mi è stato regalato dal mio collega *Stefano*, dopo mesi nel quale gli rompevo le scatole per convincerlo a provarlo, e a lui non è convinto così tanto.
Io invece l'ho davvero amato, e forse è addirittura uno dei miei puzzle game preferiti di sempre.
...
Il gioco colpisce subito per l'ottima cura riposta nel suo sviluppo: i particellari sono presenti dove servono e sono quasi eleganti, i movimenti del nostro personaggio sono fluidi, e in generali gli sprite di gioco sono davvero di ottima fattura.

I power up che troveremo nel nostro cammino sono abbastanza standard (tranne per il jetpack che prende il posto del classico doppio salto), e anche la mappa è ben studiata: è facile perdersi, ma, da metà gioco in poi, si potrà attraversare in maniera abbastanza agile tramite... beh, credo che possiate immaginarlo :D

L'irritazione che ho nominato inizialmente viene dal bilanciamento della difficoltà: non è un gioco che si può approcciare con il cervello spento, sia chiaro, ma ci sono tratti nei quali la *cattiveria* dell'autore viene a galla: salti millimetrici o da effettuare con tempismo perfetto e nemici tosti posizionati vicino a stanze in cui dovremo passare più volte o subito prima dei boss sono fanno venire davvero voglia di lanciare il controller. Il fatto è che, come dicevo, il gioco si controlla bene ed è piacevole da giocare, quindi anche dopo un *rage quit* mi sono trovato a riavviarlo con la voglia di portarlo a termine.

Come dite? Ci sono giochi apprezzati e ben pià famosi che usano gli stessi espedienti per aumetare la difficoltà del gioco? Eh già, *purtroppo*...
