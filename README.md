...
```
git clone https://github.com/11ty/scario-side-quest.git .
```
...
- [Netlify](https://scario-side-quest.netlify.app/)
- [Vercel](https://demo-base-blog.11ty.dev/)
- [Cloudflare Pages](https://scario-side-quest-d2a.pages.dev/)
- [Remix on Glitch](https://glitch.com/~11ty-eleventy-base-blog)
- [GitHub Pages](https://11ty.github.io/scario-side-quest/)
...
- [Deploy this to **Netlify**](https://app.netlify.com/start/deploy?repository=https://github.com/11ty/scario-side-quest)
...
- [Try it out on **Stackblitz**](https://stackblitz.com/github/11ty/scario-side-quest)
